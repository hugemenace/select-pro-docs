...
![Select Similar Face Islands](../../_media/similar-islands.avif ':class=avif')
...
| Only Active Face | N/A | `True` | Use only the island containing the active face as the reference; when disabled, all selected faces are used as island candidates |
